...
--
-- Host: localhost:3306
-- Generation Time: Aug 28, 2024 at 04:16 AM
...
(1, 'Professional Web Development', 'MD TOMAS UDDIN', 'I am interested  learn to professional  web development . PHP (Hypertext Preprocessor) and Laravel framework studying .', '66c0b236206b3.png');
...
(1, '66c049579c35d.png', '66c049579df14.png');
...
INSERT INTO `messages` (`id`, `name`, `email`, `subject`, `message`, `status`, `created_id`) VALUES
(1, 'Rudyard Mcconnell', 'lyryq@mailinator.com', 'Nesciunt soluta ass', 'Culpa in maxime vol', 1, '2024-08-27 12:13:55'),
(2, 'Eliana Meadows', 'hyrypiq@mailinator.com', 'Quod dignissimos ex ', 'Exercitation ex ab l', 1, '2024-08-27 12:25:18');
...
(1, 'Professional Web Development', 'PHP,(hypertext prepocessor )LARAVEL', '66c31445e8a35.png', 0),
(2, 'WED DESIGN', 'HTML,CSS,Bootstrap-5 ,JAVASCRIPT,REACT JS', '66c3147bb10cb.png', 0),
(3, 'Programing', 'data science', '66c315a22f864.png', 0),
(4, 'Video editing', '3D Animation', '66c315f76aa4f.png', 1),
...
(1, 'Professional Web Development', 'It can change the way we feel about a company and the products & services they offer.', 1),
(2, 'Professional Web Development', 'It can change the way we feel about a company and the products & services they offer.', 1),
(3, 'web design', 'html,css,javasript,react js\r\n', 1),
(4, 'Professional Web Development', 'It can change the way we feel about a company and the products & services they offer.', 1),
(6, 'Professional Web Development', 'It can change the way we feel about a company and the products & services they offer.', 1),
